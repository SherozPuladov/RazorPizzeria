...
Сервис создан с помощью Razor Pages.  Работает на базе данных MS SQL Server с помощью EF Core. Представлены операции создания и чтения. Логика написано в .cshtml.cs файлах что делает разработку удобной.
